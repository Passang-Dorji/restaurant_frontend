    ...
    return (
        <div className="container mx-auto p-6">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center mb-6">
                ...
                />
                <button
                    className="bg-gray-500 text-white font-semibold p-3 rounded-r-lg mt-2 sm:mt-0 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500"
            ...
            <div className="bg-gray-100 flex flex-col items-center min-h-screen">
                {!dishes.length ? (
                    <div className="overflow-x-auto w-full sm:w-3/4 lg:w-1/2 mb-6">
                        <table className="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
                            <thead className="bg-gray-800 text-white">
                                <tr>
                                    <th className="py-3 px-6 text-left text-sm font-medium tracking-wider">Restaurant Name</th>
                            ...
                            <tbody>
                                {dishes.map((dish, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="py-4 px-6 text-sm text-gray-700">{dish.prices[0].amount}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                        <button
                            className="mt-4 bg-gray-500 text-white font-semibold py-2 px-4 rounded-lg hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500"
                            onClick={() => setDishes([])}
                        >
                            Back
                        </button>
